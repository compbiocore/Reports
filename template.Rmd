...
wgs_summary_statistics <- function(input_directory){
  wgs_metrics_files <- list.files(path = input_directory, pattern = 'CollectWgsMetrics.txt')
  wgs_metrics <- read.table(wgs_metrics_file, skip=6, nrows=2, header=TRUE, sep='\t')

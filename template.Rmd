...
```{r, include=FALSE}
### Basic Stats ###
general_stats_func<- function(input_directory){
...
adapter_content_tidy_ggplot <- ggplotly(ggplot(adapter_content_tidy, aes(x=position, y=percent_of_sequences, color=Sample)) + geom_line() + theme_classic() + theme(legend.position='none'))
